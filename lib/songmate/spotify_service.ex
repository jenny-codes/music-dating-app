defmodule Songmate.SpotifyService do
  ...
  def fetch_music_preferences(conn) do
  ...
  @spec fetch_top_tracks(%{__struct__: Plug.Conn | Spotify.Credentials}) :: [%Track{}]
  ...
  @spec fetch_top_artists_and_genres(%{__struct__: Plug.Conn | Spotify.Credentials}) ::
          {[%Artist{}], [%Genre{}]}
