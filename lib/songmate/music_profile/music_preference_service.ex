defmodule Songmate.Accounts.MusicPreferenceService do
  ...
  @spec batch_upsert_for_user([%{}] | nil, integer()) :: any
  def batch_upsert_for_user(nil, _user_id), do: nil
  def batch_upsert_for_user([], _user_id), do: nil

  def batch_upsert_for_user(prefs, user_id) do
